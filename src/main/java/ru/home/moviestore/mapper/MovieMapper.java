...
public class MovieMapper {
    public Movie dtoToEntity(MovieDto dto) {
        return Movie.builder()
            ...
            .state(Movie.State.values()[Integer.valueOf(dto.getState())])
    ...
    public MovieDto entityToDto(Movie entity) {
        return MovieDto.builder()
            ...
            .state(String.valueOf(entity.getState().ordinal()))
    ...
    private Set<DescriptDto> getDescriptsDto(Set<Descript> descripts) {
        return descripts.stream()
            .sorted(Comparator.comparing(Descript::getId))
